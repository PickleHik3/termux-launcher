...
/** The spare-page rule is applied to whatever the repository loaded, not only to later changes. */
...
public class WidgetPaneLoadTrimTest {
    @Test public void pagesSavedBeforeTheRuleAreTrimmedWhenTheControllerStarts() {
        ...
        assertEquals("no widgets: one page, which is the spare", 1, repository.pageCount());
    }
}
