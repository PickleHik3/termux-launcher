...
Acceptance suite green (KeyPopup* = 28 tests, 0 failures). Commit: see git log.

## In progress
Nothing.

## Next
Full `testDebugUnitTest` before the final commit, then the Waydroid gate (feel of size/position,
