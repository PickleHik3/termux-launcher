...
public final class KeyModifier
{
  ...
  /** @deprecated Use the scoped [modify(KeyValue, Modifiers, Modmap)] overload. */
  @Deprecated
  public static synchronized void set_modmap(Modmap mm)
  {
    _modmap = mm;
  }

  /** Modify a key according to modifiers. */
  public static synchronized KeyValue modify(KeyValue k, Pointers.Modifiers mods)
  {
    if (k == null)
      return null;
  ...
  /** Apply modifiers with a layout-owned modmap without retaining global state. */
  public static synchronized KeyValue modify(KeyValue k,
      Pointers.Modifiers mods, Modmap modmap)
  {
    Modmap saved = _modmap;
    _modmap = modmap;
    try
    {
      return modify(k, mods);
    }
    finally
    {
      _modmap = saved;
  ...
  /** Like [modify] but do not apply user modmaps. Used when evaluating macros
      to avoid loops. */
  public static synchronized KeyValue modify_no_modmap(KeyValue k,
  ...
  public static synchronized KeyValue modify(KeyValue k, KeyValue mod)
  {
    switch (mod.getKind())
    {
      case Modifier:
  ...
  public static synchronized KeyValue modify(KeyValue k, KeyValue.Modifier mod)
  {
    switch (mod)
    {
