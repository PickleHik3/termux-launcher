...
public final class TermuxPropertyConstants {
     ...
     */
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[[{key: KEYBOARD, display: '󰥻', popup: {key: 'tool:terminal.select_at_cursor', display: '󱈅'}}, {key: 'tool:session.new', display: '󰝜', popup: {key: 'tool:window.new', display: '󱂬'}}, {key: 'tool:pane.split_vertical', display: '󰯌', popup: {key: 'tool:pane.split_horizontal', display: '󰯋'}}, {key: 'tool:terminal.jump_previous_prompt', display: '󰄿', popup: {key: 'tool:terminal.jump_next_prompt', display: '󰄼'}}, {key: 'tool:terminal.search_scrollback', display: '󱎸', popup: {key: 'tool:terminal.hints', display: '󰌹'}}, {key: 'tool:workspace.picker', display: '󱇙', popup: {key: 'tool:workspace.save_prompt', display: '󰠘'}}, {key: 'tool:terminal.toggle_scratchpad', display: '󱞂', popup: {key: 'tool:pane.toggle_float', display: '󰹗'}}]]";
