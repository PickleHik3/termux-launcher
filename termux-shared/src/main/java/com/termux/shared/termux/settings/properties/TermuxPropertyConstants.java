...
public final class TermuxPropertyConstants {
     ...
     */
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[[{key: KEYBOARD, display: '󰥻', popup: {key: 'tool:keyboard.cycle_form', display: ''}}, {key: 'tool:mouse.toggle', display: '󰍽'}, {key: 'tool:wall.widgets', display: '', color: 'primary_container'}, {key: 'tool:wall.terminal', display: '', color: 'secondary_container'}, {key: 'tool:wall.display', display: '', color: 'tertiary_container'}, {key: 'tool:pane.split', display: '󱇚', popup: {key: 'tool:window.new', display: '󱂬'}}, {key: 'tool:session.browser', display: '󰉹', popup: {key: 'tool:session.new', display: '󰝜'}}]]";
