...
public final class TermuxPropertyConstants {
     ...
     */
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[[{key: KEYBOARD, display: '󰥻', popup: {key: 'tool:mouse.toggle', display: ''}}, {key: 'tool:session.new', display: '󰝜', popup: {key: 'tool:window.new', display: '󱂬'}}, {key: 'tool:wall.widgets', display: ''}, {key: 'tool:wall.terminal', display: ''}, {key: 'tool:wall.display', display: ''}, {key: 'tool:pane.split_vertical', display: '󰯌', popup: {key: 'tool:pane.split_horizontal', display: '󰯋'}}, {key: 'tool:workspace.picker', display: '󱇙', popup: {key: 'tool:workspace.save_prompt', display: '󰠘'}}]]";
